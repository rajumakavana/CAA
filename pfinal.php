...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <div class="d-inline-flex">
                ...
                <p class="m-0 text-white px-2">Final Result</p>
    ...
    <!-- Start Final Result -->
    <h2 align=center>Selected Player List   </h2>
     ...
     <table class="table table-hover">
        ...
        <?php
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `selectedp` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or  `mobile` LIKE '%$filter%' or `email` LIKE '%$filter%' or  `country` LIKE '%$filter%';";
                  ...
                  echo "<td> $row[13]</td>";
                  echo "<td> $row[14]</td>";
                  echo "<td> <img src='$row[16]' width='40px' height='40px'></td>";
                  echo "<td><a class='btn btn-success' href='certificate.php?id=$row[0]'><i class='fa fa-download'></i></a></td>";
                  echo "</tr>";
                      }
                  }
                  else
                  {
                    echo "<td colspan='17' align='center'>No Data Found</td>";
                  echo "</tr>";
                  }
              }
              else
