...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h4 class="display-5 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Player Trial Result</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white px-2">Result</p>
    ...
    <!-- Start Trial Result -->
            <h2 align=center>In This List Which Player Who Given The Trial</h2>
  ...
  <tbody>
      <?php
            ...
            mysqli_select_db($con, 'crickproject');
            if(isset($_POST['find']))
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `ptrial` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or  `mobile` LIKE '%$filter%' or `email` LIKE '%$filter%' or `age` like '%$filter%' or  `country` LIKE '%$filter%';";
                ...
                {
                    echo "<td colspan='10' align='center'>No Data Found";
                        echo "</tr>";
                }
              }
              else{
              ...
              {
                echo "<tr>";
                echo  "<td colspan='8' align='center'>Result Declare Soon...</td>";
                echo "</tr>";
              }
              else
              {
