...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            ...
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white">Coach</a></p>
    ...
    $query = mysqli_query($con, "SELECT coach_id FROM `finalplist` WHERE id='$id';");
    ...
    ?>
    <?php
    $query2 = mysqli_query($con, "SELECT * FROM `finalclist` WHERE id='$coach';");
    ...
    if($cid==0)
        {
            echo "<h3 align='center'>Coach Will Be Added You Please Wait...</h3>";
        }
        else
        {
    ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="user-photo m-b-30">
                                            <img class="img-fluid" src="<?php echo "../" . $photo; ?>" alt="Profile Image" />
                                            <br>
                                        </div>
                                    </div>
                                    <div class="user-work">
                                        ...
                                        <div class="birthday-content">
                                            <span class="contact-title"><b>Coach ID:</b></span>
                                            <span class="birth-date"><?php echo $cid; ?></span>
                                        </div>
                                        <div class="birthday-content">
                                            <span class="contact-title"><b>Coach Name:</b></span>
                                            <span class="birth-date"><?php echo $fname;
                                                                        echo '&nbsp'; ?><?php echo $lname; ?></span>
                                        </div>

                                        <div class="gender-content">
                                            <span class="contact-title"><b>Gender:</b></span>
                                            <span class="gender"><?php echo $gn; ?></span>
                                        </div>
                                        <br>
                                        <h4><u>Coaching Information</u></h4>
                                        <div class="birthday-content">
                                            <span class="contact-title"><b>Coaching Type:</b></span>
                                            <span class="birth-date"><?php echo $type; ?></span>
                                        </div>
                                        <br>
                                        <h4><u>Contact Information</u></h4>
                                        <div class="birthday-content">
                                            <span class="contact-title"><b>Phone:</b></span>
                                            <span class="birth-date"><?php echo $phone; ?></span>
                                        </div>
                                        <div class="birthday-content">
                                            <span class="contact-title"><b>Email:</b></span>
                                            <span class="birth-date"><?php echo $email; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
