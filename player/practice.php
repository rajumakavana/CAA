...
<body class="bg-white">
    ...
    <!-- Navbar End -->
      ...
      <div class="container-fluid page-header mb-3">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h4 class="display-5 mb-2 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Stadium</h4>
    ...
    <?php
            $query = mysqli_query($con, "SELECT practice_time FROM `finalplist` WHERE id='$id';");
    ...
    ?>
           ...
           <center><h3><b>Your Practice Time :</b></h3><h class="display-4 mb-3 mt-0 mt-lg-5 text-black text-uppercase font-weight-bold"><?php echo $time;?></h4></center>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex align-items-center mb-2">
                    <div class="pl-3">
                        <h1 class="font-weight-bold mb-3">Please Read This Intructions Carefully</h1>
                    </div>
                </div>
                
                <ul class="text-dark">
                            <li>This Time Follow 24 Hours Format</li>
                            <li>Player Reach Ground At Allocated Time</li>
                            <li>Follow Coach Instructions And Start Your Session.</li>
                            <li>When Player Leave/Late At Practice Time That Report Must Be Submit In Query Report Otherwise Cricket Academy & Association Take Action Against You.</li>
                            <li>If Some Condition  Cricket Academy & Association Change Your Time  So,You Need To Check Your Time</li>
                            <li>All Player Must Follow  Cricket Academy & Association Rules Otherwise Player Remove From Practice Session.</li>
                </ul>
