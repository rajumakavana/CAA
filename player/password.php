...
<body class="bg-white">
    ...
    $psq = "SELECT * FROM `finalplist` WHERE 'id'='$id';";
    ...
    if (isset($_POST['passc'])) 
    {
        ...
        $renewpass=md5($_POST['renewpsss']);
            ...
            if ($newpass != $renewpass) 
            {
             ...
             {
                $sqp = "UPDATE `finalplist` SET `password`='$renewpass',`re_pass`='$renewpass' WHERE `id`='$id';";
                ...
                <form method="post" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6 pr-1">
                            <div class="form-group">
                                <input type="submit" class='btn btn-outline-success' name="passc" value="Change">
                            </div>
                        </div>
                    </div>
            </div>
