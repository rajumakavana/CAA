...
<body class="bg-white">
    ...
    <!-- Navbar End -->
     ...
     <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h4 class="display-5 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Management</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" href="">Home</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white px-2">Association</p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Management</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    <img class="card-img-top" src="<?php echo 'admin/'.$fetch[4]; ?>" alt="Image">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch2[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch3[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch4[3]; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container pt-5 team">
        <div class="d-flex flex-column text-center mb-5">
            <h4 class="display-4 font-weight-bold">Meet Our Staff</h4>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch5[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch6[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch7[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch8[3]; ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch9[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch10[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch11[3]; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <p class="card-text"><?php echo $fetch12[3]; ?></p>
                    </div>
                </div>
            </div>
        </div>
