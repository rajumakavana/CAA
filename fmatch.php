...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h4 class="display-5 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Future Matches</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white px-2">Stadium</p>
                <p class="m-0 text-white px-2">/</p>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `fmatches` WHERE  `format` like '%$filter%' or `name1` like '%$filter%' or `name2` like '%$filter%' or `matchno` like '%$filter%' ;";
                  ...
                  if(mysqli_num_rows($res)>0)
                  {
                    ...
                    echo "<td>$team1</td>";
                    echo "<td>$team2</td>";
                    echo "<td> <a class='btn btn-success' href='ticket.php?id=$row[0]'><i class='fa fa-book'></i></a></td>";
                    echo "</tr>";
                      }
                    }
                    else
                    {
                        echo "<td colspan='7' align='center'>No Record Available</td>";
                        echo "<tr>";
                    }
                }
                else{
                ...
                while ($fetch = mysqli_fetch_array($query)) {
                    ...
                    echo "<td>$team1</td>";
                    echo "<td>$team2</td>";
                    echo "<td> <a class='btn btn-success' href='ticket.php?id=$fetch[0]'><i class='fa fa-book'></i></a></td>";
                    echo "</tr>";
                }
            }
            else
            {
                ...
                echo "<td colspan='7' align='center'>No Matches Available</td>";
                echo "<tr>";
            }
        }
                ?>
