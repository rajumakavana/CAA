...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="playertrial.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Trial Table</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      ...
      <div class="text-center" style="color: #007BFF; font-weight:bold; "> &nbsp;Trial Player Details</div>
      <!-- Dark Table -->
      ...
      <table class="table table-dark">
        ...
        <?php
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `ptrial` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or  `mobile` LIKE '%$filter%' or `email` LIKE '%$filter%' or `country` LIKE '%$filter%';";
                  ...
                  if(mysqli_num_rows($qry)>0)
                  {
                      while($row=mysqli_fetch_array($qry))
                      {
                        ...
                        echo "<td> $row[14]</td>";
                        echo "<td> $row[15]</td>";
                        echo "<td><img src='../$row[16]' width='40px' heigh='40px'></td>";
                        echo "<td><a class='btn btn-danger' href='tdelete.php?id=$row[0]'><i class='bi bi-x-square'></i></a></td>";
                        echo "<td><a class='btn btn-success' href='pselect.php?id=$row[0]'><i class='bi bi-check2-square'></a></td>";
                        echo "</tr>";
                      }
                    }
                    else
              ...
              $qry = mysqli_query($con, $data);
                while ($row = mysqli_fetch_array($qry)) {
                  ...
                  echo "<td><img src='../$row[16]' width='40px' heigh='40px'></td>";
                  echo "<td><a class='btn btn-danger' href='tdelete.php?id=$row[0]'><i class='bi bi-x-square'></i></a></td>";
                  echo "<td><a class='btn btn-success' href='pselect.php?id=$row[0]'><i class='bi bi-check2-square'></i></a></td>";
                  echo "</tr>";
                } 
              }
              ?>
