...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav1" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="coachreg.php" >
          ...
          <li>
            <a href="coachpractice.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Coach Practice</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Coach </a></li>
          <li class="breadcrumb-item active">Practice Time Table</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <tbody>
              ...
              if(isset($_POST['find']))
              {
                ...
                <tr>
                  ...
                  <td><?php echo $fetch['coach_type'] ?></td>
                  <td><img src="../<?php echo $fetch['photo'] ?>" height="60" width="60" /></td>
                  <td><?php echo $fetch['practice_time'] ?></td>
          
                  <td align="center"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#update<?php echo $fetch['id'] ?>"><span class="glyphicon glyphicon-edit"></span><i class="bi bi-pencil-square"></i></button></td>

                  <div class="modal fade" id="update<?php echo $fetch['id'] ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form method="POST"  action="practiceup.php">
                          ...
                          <div class="modal-footer">
                            ...
                            <button class="btn btn-success" name="dtime"><span class="glyphicon glyphicon-save"></span> Update</button>
                          </div>
                        </form>
                      </div>
                    </div>
              ...
              $query = mysqli_query($con, "SELECT * FROM `finalclist`");
              while ($fetch = mysqli_fetch_array($query)) {
              ?>
                <tr>
                  <td><?php echo $fetch['id'] ?></td>
