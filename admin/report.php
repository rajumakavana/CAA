          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">T20</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">ODI</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password">TEST</button>
                </li>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                      ...
                      <tbody>
                        ...
                        $query = mysqli_query($con, "SELECT * FROM `t20`;");
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                      ...
                      <tbody>
                        ...
                        $query = mysqli_query($con, "SELECT * FROM `odi`;");
                        if (mysqli_num_rows($query) > 0) {
                          while ($fetch = mysqli_fetch_array($query)) {
                            $id = $fetch[0];
                            $name = $fetch[1];
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overviewt20">T20</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-editodi">ODI</button>
                </li>

                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profiletest">TEST</button>
                </li>

              </ul>
              <div class="tab-content pt-2">
                <div class="tab-pane fade show active profile-overviewt20" id="profile-overviewt20">
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                      <thead class="table-info">
                        <tr>
                      ...
                      <tbody>
                        ...
                        $query = mysqli_query($con, "SELECT * FROM `totalt20`");
                        if (mysqli_num_rows($query) > 0) {
                          while ($fetch = mysqli_fetch_array($query)) {
                            $id = $fetch[0];
                            $name = $fetch[1];
                ...
                <div class="tab-pane fade profile-editodi pt-3" id="profile-editodi">
                  <table class="table table-hover table-bordered">
                    <thead class="table-info">
                      <tr>
                        <th>Player Id</th>
                    ...
                    <tbody>
                      <?php
                      $query = mysqli_query($con, "SELECT * FROM `totalodi`");
                      if (mysqli_num_rows($query) > 0) {
                        while ($fetch = mysqli_fetch_array($query)) {
                          $id = $fetch[0];
                          $name = $fetch[1];
              ...
              <div class="tab-pane fade profiletest pt-3" id="profiletest">
                <table class="table table-hover table-bordered">
                  <thead class="table-info">
                    <tr>
                      <th>Player Id</th>
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($con, "SELECT * FROM `totaltest`");
                    if (mysqli_num_rows($query) > 0) {
                      while ($fetch = mysqli_fetch_array($query)) {
                        $id = $fetch[0];
                        $name = $fetch[1];
