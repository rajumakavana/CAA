...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav1" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
        <li>
          <a href="coachreg.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Coach Register Table</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="text-center" style="color: #007BFF; font-weight:bold; "><i class="fas fa-user"></i> &nbsp;Coach Details</div>
      <!-- Dark Table -->
      ...
      <table class="table table-dark">
        ...
        <?php
            ...
            {
                $filter=$_POST['search'];
                $sql="SELECT * FROM `regcoach` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or `father_name` LIKE '%$filter%' or `mobile` LIKE '%$filter%' or `email` LIKE '%$filter%' or `district` LIKE '%$filter%' or `state` LIKE '%$filter%' or `country` LIKE '%$filter%';";
                ...
                if(mysqli_num_rows($qry)>0)
                {
                  ...
                  echo "<td><a class='btn btn-success' href='cselect.php?id=$row[0]'><i class='bi bi-check-lg'></i></a></td>";
                  echo "<td><a class='btn btn-danger' href='cfailed.php?id=$row[0]'><i class='bi bi-trash'></i></a></td>";
                  echo "<td><a class='btn btn-primary' href='../cprint.php?id=$row[0]'><i class='bi bi-download'></i></a></td>";
                  echo "</tr>";
                    }
                }
                else{
                  echo "<td align='center' colspan='20'>No Record Available</td>";
                  echo "</tr>";
                }
            }
            else{
              ...
              {
                echo "<td align='center' colspan='20'>No Record Registered</td>";
                echo "</tr>";
              }
            }
              ?>
