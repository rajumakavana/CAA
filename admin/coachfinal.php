    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav1" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="coachfinal.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Coach Final List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <?php
            if(isset($_POST['find']))
            {
                ...
                if(mysqli_num_rows($qry)>0)
                {
                  ...
                  echo "<td><a class='btn btn-danger' href='cdelete.php?id=$row[0]'><i class='bi bi-trash'></i></a></td>";
                  echo "</tr>";
                    }
                  }
                  else
                  {
                    echo "<td colspan='18' align='center'>No Record Found</td>";
                  echo "</tr>";
                  }
                }
                else{
