    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="adteam.php" class="active">
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `team` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or `role` LIKE '%$filter%';";
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?php echo $fetch['id'] ?>"><span class="glyphicon glyphicon-edit"></span><i class="bi bi-pencil-square"></i></button></td>

                  <div class="modal fade" id="edit<?php echo $fetch['id'] ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form method="POST" enctype="multipart/form-data" action="editteam.php">
                          <div class="modal-header">
                            <h3 class="modal-title">Update Player</h3>
                          </div>
                          <div class="modal-body">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter First Name" value="<?php echo $fetch['first_name']; ?>" name="fname" required="required" />
                              </div>
                              <div class="form-group">
