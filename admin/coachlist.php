    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav1" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="coachlist.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Coach List Table</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <section class="section">
    <div class="text-center" style="color: #007BFF; font-weight:bold; "><i class="fas fa-user"></i> &nbsp;Coach List</div>
      <!-- Dark Table -->
