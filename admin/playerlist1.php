       ...
       <table class="table table-dark table-hover">
        ...
        <?php
              if(isset($_POST['find']))
              {
                  ...
                  echo "<td><a class='btn btn-danger' href='remove.php?id=$row[0]'><i class='bi bi-trash'></i></a></td>";
                  echo "<td><a class='btn btn-primary' href='certificate.php?id=$row[0]'><i class='bi bi-download'></i></a></td>";
                  echo "</tr>";
                      }
                    }
                    else
                    {
                      echo "<td align='center' colspan='22'>No Record Found</td>";
                      echo "</tr>";
                    }
                  }
                  else{
