          ...
          <tbody>
            ...
            ?>
              ...
              <td><?php echo $fetch['id'] ?></td>
                ...
                <td><img src="<?php echo $fetch['photo'] ?>" height="80" width="120" /></td>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="col-md-8">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" value="<?php echo $fetch['name'] ?>" name="namep" required="required" />
                            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input class="form-control" name="iname" type="text" placeholder="Image Name">
                </div><br>
