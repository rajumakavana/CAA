...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Player Gym Time</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Player</a></li>
          <li class="breadcrumb-item active">Gym Time Table</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <tbody>
              ...
              if(isset($_POST['find']))
              {
                ...
                <tr>
                  ...
                  <td><?php echo $fetch['gym_time'] ?></td>
          
                  <td align="center"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#gym<?php echo $fetch['id'] ?>"><span class="glyphicon glyphicon-edit"></span><i class="bi bi-pencil-square"></i></button></td>

                  <div class="modal fade" id="gym<?php echo $fetch['id'] ?>" aria-hidden="true">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $fetch['gym_time'] ?>" name="current_time" readonly/>
                                <br>
                              </div>
                              <div class="form-group">
