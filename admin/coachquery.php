...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav1" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="coachquery.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Query Table</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="text-center" style="color: #007BFF; font-weight:bold; "><i class="fas fa-user"></i> &nbsp;Coaches Queries</div>
      <!-- Dark Table -->
      ...
      <table class="table table-danger">
        ...
        <?php
            ...
            {
                $filter=$_POST['search'];
                $sql="SELECT * FROM `cquery` WHERE `coach_id` like '%$filter%' or `name` LIKE '%$filter%' or  `email` LIKE '%$filter%'  or `subject` LIKE '%$filter%' or `report_date` LIKE '%$filter%';";
                ...
                if(mysqli_num_rows($qry)>0)
                {
                    while($row=mysqli_fetch_array($qry))
                    {
                      ...
                      echo "<td> $row[4]</td>";
                      echo "<td> $row[5]</td>";
                      echo "<td><a class='btn btn-danger' href='cqd.php?id=$row[0]'><i class='bi bi-trash'></i></a></td>";
                      echo "</tr>";
                    }
                  }
                  else
                  {
                      echo "<td colspan='7' align='center'> No Queries Found</td>";
                      echo "</tr>";
                  }
                }
                else
              ...
              {
                  echo "<td colspan='7' align='center'> No Queries Reported</td>";
                  echo "</tr>";
              }
                }
              ?>
