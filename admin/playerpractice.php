...
<head>
  ...
  <title>Player Practice Time</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="playerlist1.php" class="active">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="playerpractice.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Player Practice Time</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Player</a></li>
          <li class="breadcrumb-item active">Practice Table</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="table-responsive">
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `finalplist` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or `father_name` LIKE '%$filter%' or  `mobile` LIKE '%$filter%' or `email` LIKE '%$filter%' or `district` LIKE '%$filter%' or `state` LIKE '%$filter%' or `country` LIKE '%$filter%';";
                ...
                <tr>
                  ...
                  <td><?php echo $fetch['first_name']; echo '&nbsp';echo $fetch['last_name'];?></td>
                  <td><?php echo $fetch['gender'] ?></td>
                  <td><?php echo $fetch['email'] ?></td>
                  <td><?php echo $fetch['batting'] ?></td>
                  <td><?php echo $fetch['wk'] ?></td>
                  <td><?php echo $fetch['bowling_arm'] ?></td>
                  <td><?php echo $fetch['bowling_pace'] ?></td>
                  <td><?php echo $fetch['practice_time'] ?></td>
          
                  <td align="center"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#practice<?php echo $fetch['id'] ?>"><span class="glyphicon glyphicon-edit"></span><i class="bi bi-pencil-square"></i></button></td>

                  <div class="modal fade" id="practice<?php echo $fetch['id'] ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form method="POST"  action="playerprac.php">
                          <div class="modal-header">
                            <h3 class="modal-title">Update Practice Time</h3>
                          </div>
                          <div class="modal-body">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="form-group">
                                <label>Current_Time :</label>
                                <input type="hidden" value="<?php echo $fetch['id'] ?>" name="user_id" />
                                <input type="text" class="form-control" value="<?php echo $fetch['practice_time'] ?>" name="current_time" readonly/>
                                <br>
                              </div>
                              <div class="form-group">
                                <label>New_Time :</label>
                                <input type="time" class="form-control" placeholder="Enter New Time" name="new_time" />
                              </div>
                            </div>
                          </div>
                          <br style="clear:both;" />
                          <div class="modal-footer">
                            ...
                            <button class="btn btn-success" name="ptime"><span class="glyphicon glyphicon-save"></span>Update</button>
                          </div>
                        </form>
                      </div>
                    </div>
                ...
                <?php
                    ...
                    {
                      echo "<td align='center' colspan='10'>No Record Found</td>";
                      echo "</tr>";
                    }
                  }
                  else{
              $query = mysqli_query($con, "SELECT * FROM `finalplist`");
              while ($fetch = mysqli_fetch_array($query)) {
              ?>
                <tr>
                  <td><?php echo $fetch['id'] ?></td>
