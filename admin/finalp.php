...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="finalp.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="text-center" style="color: #007BFF; font-weight:bold; "> &nbsp;Final Player Details</div>
      <!-- Dark Table -->
      ...
      <table class="table table-dark">
        ...
        <?php
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `selectedp` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or  `mobile` LIKE '%$filter%' or `email` LIKE '%$filter%';";
                  ...
                  echo "<td><a class='btn btn-success' href='padd.php?id=$row[0]'><i class='bi bi-check2-circle'></i></a></td>";
                  echo "</tr>";
                      }
                    }
                    else
                    {
                      echo "<td colspan='20' align='center'>No Record Available</td>";
                  echo "</tr>";
                    }
                  }
                  else
                  {
              $data = " SELECT * FROM `selectedp` ";
