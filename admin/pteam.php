            ...
            <tbody>
              ...
              if(isset($_POST['find']))
              {
                ...
                <tr>
                  ...
                  <td><?php echo $fetch['team_name'] ?></td>
          
                  <td align="center"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#team<?php echo $fetch['id'] ?>"><span class="glyphicon glyphicon-edit"></span><i class="bi bi-pencil-square"></i></button></td>

                  <div class="modal fade" id="team<?php echo $fetch['id'] ?>" aria-hidden="true">
                        ...
                        <form method="POST"  action="team.php">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="form-group">
                                <label>Current_Team :</label>
                                <input type="hidden" value="<?php echo $fetch['id'] ?>" name="user_id" />
                                <input type="text" class="form-control" value="<?php echo $fetch['team_name'] ?>" name="current_team" readonly/>
                                <br>
                              </div>
                              <div class="form-group">
                                <label>New_Team :</label>
                                <input type="text" class="form-control" placeholder="Enter New Team Name" name="new_team" />
                              </div>
                            </div>
                          </div>
                          <br style="clear:both;" />
