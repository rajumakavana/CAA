...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="featurem.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Stadium</a></li>
          <li class="breadcrumb-item active">Feature Matches</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add New Match</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" placeholder="Select Match Date" name="date">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Set Time</label>
                        <input type="time" class="form-control" placeholder="Select Match Time" name="time">
                      </div>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Team " name="team1">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Second Team Name</label>
                        <input type="text" class="form-control" placeholder="Enter Opponent Team" name="team2">
                      </div>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="submit"  class='btn btn-success' name="fdone">
                      </div>
                    </div>
                  </div>
      ...
      <div class="table-responsive">
          <table class="table table-hover table-bordered table-primary">
            ...
            <tbody>
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `fmatches` WHERE `matchno` like '%$filter%' or `format` LIKE '%$filter%' or `date` LIKE '%$filter%' or `time` LIKE '%$filter%' or `name1` LIKE '%$filter%' or `name2` LIKE '%$filter%';";
                  ...
                  echo "<td>$team1</td>";
                  echo "<td>$team2</td>";
                  echo  "<td><a href='fmatchdel.php?id=$fetch[0]' class='btn btn-outline-success'><i class='bi bi-clipboard-check'></i></a></td>";
                  echo "</tr>";
                      }
                    }
                    else
                    {
                      echo  "<td align='center' colspan='7'>No Record Available</td>";
                  echo "</tr>";
                    }
                  }
                  else{
              $query = mysqli_query($con, "SELECT * FROM `fmatches`");
              while ($fetch = mysqli_fetch_array($query)) {
                  $matchno=$fetch[0];
                  $format=$fetch[1];
                  $date=$fetch[2];
   ...
   <?php
        ...
        if(isset($_POST['fdone']))
        {
            ...
            $fmatch="INSERT INTO `fmatches`(`format`, `date`, `time`, `name1`, `name2`) VALUES ('$format','$date','$time','$team1','$team2')";
            $qmatch=mysqli_query($con,$fmatch);
            if($qmatch)
            {
                echo "<script>alert('Feature Match Added Successfully');</script>";
