        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              $query = mysqli_query($con, "SELECT * FROM `slide`");
              ...
              ?>
                <tr>
                  ...
                  <td><img src="<?php echo $fetch['photo'] ?>" height="80" width="140" /></td>

                  <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#edit<?php echo $fetch['id'] ?>"><span class="glyphicon glyphicon-edit"></span><i class="bi bi-pencil-square"></i></button></td>
                  
                  <div class="modal fade" id="edit<?php echo $fetch['id'] ?>" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form method="POST" enctype="multipart/form-data" action="editslide.php">
                          <div class="modal-header">
                            <h3 class="modal-title">Update Slide</h3>
                          </div>
                          <div class="modal-body">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Slide Name" name="name" required="required" />
                              </div>
                              <div class="form-group">
                                <label>Discription</label>
                                <textarea class="form-control" name="disc" rows="2" placeholder="Enter Discription"></textarea>
                              </div>
                            </div>
                          </div>
                          <br style="clear:both;" />
