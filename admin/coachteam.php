    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav1" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="coachteam.php" class="active">
                      ...
                      <div class="modal-content">
                        <form method="POST"  action="teamup.php">
                          <div class="modal-header">
                            <h3 class="modal-title">Update Team Name</h3>
                          </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <button class="btn btn-success" name="dteam"><span class="glyphicon glyphicon-save"></span> Update</button>
                          </div>
                        </form>
                      </div>
                    </div>
