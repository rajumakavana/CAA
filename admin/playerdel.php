...
try {
  ...
  $mail->Body    = 'Hello, We Sorry To Say  <b>You No Longer Player Of Cricket Academy & Association .</b>Best Wishes , Good Bye . Thank You, <b>Cricket Academy & Association Team</b>';
  $mail->AltBody = '';
...
if ($qr) 
{
                  echo "<script>alert('Player Record Delete Sucessfully');</script>";
