...
<aside id="sidebar" class="sidebar">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Coach-Player Report</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Coach </a></li>
          <li class="breadcrumb-item active">Player Report</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
