...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="pquery.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="text-center" style="color: #007BFF; font-weight:bold; "><i class="fas fa-user"></i> &nbsp;Players Queries</div>
      <!-- Dark Table -->
      ...
      <table class="table table-dark">
        ...
        <?php
            ...
            {
                $filter=$_POST['search'];
                $sql="SELECT * FROM `pquery` WHERE `player_id` like '%$filter%' or `name` LIKE '%$filter%' or  `email` LIKE '%$filter%'  or `subject` LIKE '%$filter%' or `report_date` LIKE '%$filter%';";
                ...
                if(mysqli_num_rows($qry)>0)
                {
                  while ($row = mysqli_fetch_array($qry)) {
                    ...
                    echo "<td> $row[4]</td>";
                    echo "<td> $row[5]</td>";
                    echo "<td><a class='btn btn-danger' href='pqd.php?id=$row[0]'><i class='bi bi-trash'></i></a></td>";
                    echo "</tr>";
                  }
                }
                else
