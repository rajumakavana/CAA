...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h4 class="display-5 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Player List</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" href="index.php">Home</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white px-2">Association</p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white px-2">Player List List</p>
    ...
    <!-- End Search Bar -->
    <!-- End Player List  -->
     <div> <h2 align="center">List Of Academy Player </h2></div> 
    ...
    <div class="table-responsive">
     <table class="table table-hover">
        ...
        <?php
              ...
              {
                  $filter=$_POST['search'];
                  $sql="SELECT * FROM `finalplist` WHERE `id` like '%$filter%' or `first_name` LIKE '%$filter%' or `last_name` LIKE '%$filter%' or `father_name` LIKE '%$filter%' or `mother_name` LIKE '%$filter%' or `mobile` LIKE '%$filter%' or `email` LIKE '%$filter%' or `district` LIKE '%$filter%' or `state` LIKE '%$filter%' or `country` LIKE '%$filter%';";
                  ...
                  {
                      echo "<td colspan='18' align='center'>No Record Available</td>";
                      echo "</tr>";
                  }
              }  
            else{
            ...
            {
                echo "<td colspan='17' align='center'>List Will Be Declare Soon...</td>";
                echo "<tr>";
            }
            }
              ?>
