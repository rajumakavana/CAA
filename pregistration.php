...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h4 class="display-5 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Player Registration</h4>
    ...
    <div class="col-lg-12">
    <center><h1><b>Player Registration Form</b></h1></center>
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form class="row g-3 needs-validation" method="post" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="validationCustom04" name="mname" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="validationCustom05" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" name="mobile" required>
                            ...
                            <div class="col-md-4">
                                <label>Select Cricket Level</label>
                                ...
                                <div class="invalid-feedback">Please Select Your Cricket Level</div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="agedata" id="age" required placeholder="Please Select Date Of Birth" required readonly>
                                <div class="invalid-feedback">
                                    Please Enter DOB
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validationFormCheck3" name="size" value="S" required>
                                    <label class="form-check-label" for="validationFormCheck3">Small</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validatonFormCheck4" name="size" value="XL" required>
                                    <label class="form-check-label" for="validationFormCheck4">Medium</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck5" name="size" value="L" required>
                                    <label class="form-check-label" for="validationFormCheck5">Large</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck6" name="size" value="Other" required>
                                    <label class="form-check-label" for="validationFormCheck6">Other</label>
                                    <div class="invalid-feedback">Please Choose T-shirt Size</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <br>
                                <label>Batting Arm :</label>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validationFormCheck7" name="bat" value="Right arm" required>
                                    <label class="form-check-label" for="validationFormCheck7" value="S">Right arm</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck8" name="bat" value="Left arm" required>
                                    <label class="form-check-label" for="validationFormCheck8" >Left arm</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck9" name="bat" value="Both" required>
                                    <label class="form-check-label" for="validationFormCheck9">Both</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck10" name="bat" value="None" required>
                                    <label class="form-check-label" for="validationFormCheck10">None</label>
                                    <div class="invalid-feedback">Please Choose Batting Arm</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <br>
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validationFormChec11" name="wk" value="Yes" required>
                                    <label class="form-check-label" for="validationFormCheck11">Yes</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck12" name="wk" value="No" required>
                                    <label class="form-check-label" for="validationFormCheck12">No</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <div class="invalid-feedback">Please Choose Wikcket Keeping</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <br>
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validationFormCheck13" name="bowl" value="Right arm" required>
                                    <label class="form-check-label" for="validationFormCheck13">Right arm</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck14" name="bowl" value="Left arm" required>
                                    <label class="form-check-label" for="validationFormCheck14">Left arm</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck15" name="bowl" value="Both" required>
                                    <label class="form-check-label" for="validationFormCheck15">Both</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck16" name="bowl" value="None" required>
                                    <label class="form-check-label" for="validationFormCheck16">None</label>
                                    <div class="invalid-feedback">Please Choose Bowling Arm</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <br>
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validationFormCheck17" name="pf" value="Batting" required>
                                    <label class="form-check-label" for="validationFormCheck17">Batting</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck18" name="pf" value="Bowling" required>
                                    <label class="form-check-label" for="validationFormCheck18">Bowling</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    
                                    <div class="invalid-feedback">Please Choose First Preference</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <br>
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validationFormCheck19" name="pace" value="Fast" required>
                                    <label class="form-check-label" for="validationFormCheck19">Fast</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck20" name="pace" value="Medium" required>
                                    <label class="form-check-label" for="validationFormCheck20">Medium</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck21" name="pace" value="Off Spiner" required>
                                    <label class="form-check-label" for="validationFormCheck21">Off Spiner</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck22" name="pace" value="Leg Spiner" required>
                                    <label class="form-check-label" for="validationFormCheck22">Leg Spiner</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck23" name="pace" value="None" required>
                                    <label class="form-check-label" for="validationFormCheck23">None</label>
                                    <div class="invalid-feedback">Please Choose Bowling Type</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validationFormCheck24" name="captain" value="Yes" required>
                                    <label class="form-check-label" for="validationFormCheck24">Yes</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <input type="radio" class="form-check-input" id="validationFormCheck25" name="captain" value="No" required>
                                    <label class="form-check-label" for="validationFormCheck25">No</label>&nbsp&nbsp&nbsp&nbsp&nbsp
                                    
                                    <div class="invalid-feedback">Please Choose Captain Experience</div>
                                    <br><br>
                                </div>
                            </div>
    ...
    if (isset($_POST['register'])) {
        ...
        $cap = $_POST['captain'];
        $p = $_POST['password'];
        $re_p = $_POST['password1'];
      
        //$pass=password_hash($p,PASSWORD_DEFAULT);
        //$re_pass=password_hash($re_p,PASSWORD_DEFAULT);
        $pass=md5($p);
        $re_pass=md5($re_p);
        ...
        $check = "SELECT * FROM `regplayer` WHERE email = '$email';";
        $r = mysqli_query($con, $check);

        if ($player = mysqli_num_rows($r) > 0) {
            echo "<script>alert('Player Already Register');</script>";
        } else {
            if ($img_up == false) {
                echo "<script>alert('Registration Cancel Please Try Later');</script>";
            } else {
                if ($pass == $re_pass) {
                    $sq = "INSERT INTO `regplayer`(`first_name`, `last_name`, `father_name`, `mother_name`, `mobile`, `gender`, `dob`, `age`, `email`, `address`, `district`, `state`, `country`, `pincode`, `tshirt_size`, `level`, `batting`, `wk`, `bowling_arm`, `bowling_pace`, `first_prefer`, `captain_exp`, `password`, `re_pass`, `p_photo`) VALUES ('$fname1','$lname','$father','$mother','$mobile','$gn','$dob','$age','$email','$add','$dist','$state','$country','$pin','$size','$level','$bat','$wk','$bow_arm','$pace','$pf','$cap','$pass','$re_pass','$img_path')";
