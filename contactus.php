...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h4 class="display-5 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Contact Us</h4>
    ...
    <div class="container pt-7">
        <div class="d-flex flex-column text-center mb-4">
            ...
            <h4 class="display-5 font-weight-bold">Email Us For Any Query</h4>
        </div>
        <div class="row px-3 pb-2">
            <div class="col-sm-4 text-center mb-3">
                <i class="fa fa-2x fa-map-marker-alt mb-3 text-primary"></i>
                <h4 class="font-weight-bold">Address</h4>
                <p>Cricket Academy & Association</p>
            </div>
            <div class="col-sm-4 text-center mb-3">
            ...
            <div class="col-sm-4 text-center mb-3">
                ...
                <p>crickteamofficial@gmail.com</p>
            </div>
        </div>
        <?php
        ...
        if(isset($_POST['send']))
        {
            ...
            $sq="INSERT INTO `contact`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$sub','$message')";
            $qry=mysqli_query($con,$sq);
            if($qry)
            {
                echo "<script>alert('Thank You For Your Valuable Message');</script>";
            }
                ...
                <div class="contact-form">
                    ...
                    <form class="needs-validation" name="sentMessage" id="contactForm"  method="post" novalidate >
                        <div class="control-form">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Your Name"  data-validation-required-message="Please enter your name" style="border-radius: 10px;" required/>
                            <div class="invalid-feedback">Enter Your Name</div>
                        </div>
                        <br>
                        <div class="control-form">
                            <input type="email" class="form-control" id="email" name="email" placeholder="Your Email"  data-validation-required-message="Please enter your email" style="border-radius: 10px;" required/>
                        ...
                        <br>
                        <div>
                            <button class="btn btn-outline-primary" type="submit" name="send" id="sendMessageButton" style="border-radius: 15px;">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
