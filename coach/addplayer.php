...
<body class="bg-white">
    ...
    <!-- Navbar End -->
      ...
      <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" title="Please Check Report Monthly">Add Player</a></p>
     ...
     <div> <h2 align="center">Add Player </h2></div>  
     ...
     <table class="table table-hover ">
        ...
        <?php
              if(isset($_POST['find']))
              {
                  ...
                  echo "<td><a class='btn btn-success' href='addp.php?id=$row[0]'><i class='fa fa-plus'></i></a></td>";
                  echo "</tr>";
                      }
                    }
                    else{
                        echo "<td align='center' colspan='9'>No Record Available</td>";
                  echo "</tr>";
                    }
              }
              else{
