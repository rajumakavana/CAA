...
<body class="bg-white">
    ...
    <!-- Navbar End -->
      ...
      <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" title="Please Check Report Monthly">Team</a></p>
     ...
     <!-- Page Header End -->
            <?php
              $query = mysqli_query($con, "SELECT team_name FROM `finalclist` WHERE id='$id';");
    ...
    <div class="col-12">
    <h4>Team Name :<b><?php echo $team;?></b></h4>
    </div> 
    <div class="table-responsive">
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              <?php
              $query = mysqli_query($con, "SELECT * FROM `finalplist` WHERE team_name='$team';");
            ...
            {
                echo "<td colspan='6' align='center'>Please Wait Team Will Be Add Shortly</td>";
                echo "<tr>";
            }
              ?>
            </tbody>
