...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            ...
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" title="Please Check Report Monthly">Query Report</a></p>
    ...
    <?php
        ...
        if(isset($_POST['send']))
        {
            ...
            $sq="INSERT INTO `cquery` (`coach_id`, `name`, `email`,`report_date`,`subject`, `message`) VALUES ('$cid', '$name', '$email','$date','$sub', '$message');";
                ...
                <div class="contact-form">
                    ...
                    <form class="needs-validation" name="sentMessage" id="contactForm"  method="post" novalidate>
                      <div class="control-group">
                            <input type="text" class="form-control" id="id" name="cid" value="<?php echo $id;?>"  data-validation-required-message="Please enter your name" style="border-radius: 10px;" readonly/>
                        ...
                        <div>
                            <button class="btn btn-outline-primary" type="submit" name="send" id="sendMessageButton" style="border-radius: 15px;">Report</button>
                        </div>
                    </form>
                </div>
            </div>
