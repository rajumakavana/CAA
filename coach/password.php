...
<body class="bg-white">
    ...
    <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h4 class="display-5 mb-2 mt-0 mt-lg-5 text-white text-uppercase ">Coach Corner</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" title="Please Check Report Monthly">Change Password</a></p>
    ...
    <?php
        $psq = "SELECT * FROM `finalclist` WHERE 'id'='$c_id';";
        ...
        $renewpass=md5($_POST['renewpsss']);
            ...
            {
                $sqp = "UPDATE `finalclist` SET `pass`='$renewpass',`re_pass`='$renewpass' WHERE `id`='$c_id';";
                ...
                <form method="post" class="needs-validation" novalidate>
                    <div class="row">   
                        ...
                        <div class="col-md-6 px-1">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="validation1" placeholder="Enter New Password" name="newpass" required>
                        ...
                        <div class="col-md-6 px-1">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="validation2" placeholder="Re-Enter New Password" name="renewpsss" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 pr-1">
                            <div class="form-group">
                                <input type="submit" class='btn btn-outline-success' name="changepass" value="Change">
                            </div>
                        </div>
                    </div>
            </div>
