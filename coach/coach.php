...
<body class="bg-white">
    ...
    <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
        <div class="navbar-nav ml-auto p-4 bg-secondary">
          <a href="coach.php" class="nav-item nav-link active">Home</a>
  ...
  <div class="container-fluid page-header mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
      <h4 class="display-5 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Welcome To Cricket Academy &
        Association</h4>
  ...
  <?php
                  if (isset($_POST['update'])) {
                    ...
                    $sq = "UPDATE `finalclist` SET `photo` = '$img_path' WHERE `finalclist`.`id` = '$id';";
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="user-photo m-b-30">
                      <img class="img-fluid" src="<?php echo "../".$_SESSION['c_photo']; ?>" alt="Profile Image" />
                      <div class="pt-2">
                    ...
                    <div class="user-work"><br>
                      ...
                      <div class="birthday-content">
                        <span class="contact-title">Coach ID:</span>
                        <span class="birth-date"><?php echo $_SESSION['c_id'];?></span>
                      </div>
                      <div class="birthday-content">
                        <span class="contact-title">Coach Name:</span>
                        <span class="birth-date"><?php echo $_SESSION['firstname']; echo '&nbsp';?><?php echo $_SESSION['lastname'];?></span>
                      </div>
                      <div class="birthday-content">
                      ...
                      <div class="birthday-content">
                        ...
                        <span class="birth-date"><?php echo $_SESSION['c_dob'];?></span>
                      </div>
                      ...
                      <div class="gender-content">
                        ...
                        <span class="gender"><?php echo $_SESSION['c_age'];?></span>
                      </div>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="1">
                          <div class="contact-information">
                            <div class="phone-content">
                              <span class="contact-title">Coaching Level:</span>
                              <span class="phone-number"><?php echo $_SESSION['c_level'];?></span>
                            </div>
                            <div class="address-content">
                              <span class="contact-title">Coaching Type (For Register):</span>
                              <span class="mail-address"><?php echo $_SESSION['c_type'];?></span>
                            </div>
                          ...
                          <div class="basic-information">
                            ...
                            <div class="skype-content">
                              ...
                              <span class="contact-skype"><?php echo $_SESSION['c_state'];?></span>
                            </div>
                            <div class="skype-content">
                              <span class="contact-title">Country:</span>
                              <span class="contact-skype"><?php echo $_SESSION['c_country'];?></span>
                            </div>
                            <div class="skype-content">
  ...
  <?php
                  if (isset($_POST['editdone'])) {
                    ...
                    $sq = "UPDATE `finalclist` SET `first_name`='$firstn',`last_name`='$lastn',`father_name`='$fname',`mobile`='$mobile',`gender`='$gn',`dob`='$date',`age`='$age',`email`='$email',`address`='$add',`district`='$dist',`state`='$state',`country`='$coun',`pincode`='$pin' WHERE `id` = '$id';";
                    $qry = mysqli_query($con, $sq);
                    if ($qry) {
          ...
          <form method="POST" class="needs-validation" novalidate>
            <div class="form-row">
              <div class="col">
                ...
                <input type="text" id="validation2" name="firstname" class="form-control" placeholder="First name" value="<?php echo $_SESSION['firstname']; ?>" required>
                <div class="invalid-feedback">Please Enter First Name</div>
              </div>
              <div class="col">
                <label>&nbsp Last Name :</label>
                <input type="text" id="validation3" name="lastname" class="form-control" value="<?php echo $_SESSION['lastname']; ?>" required>
            ...
            <div class="form-row">
              <div class="col">
                ...
                <input type="text" id="validation4" name="father" class="form-control" value="<?php echo $_SESSION['f_name']; ?>" required>
            ...
            <div class="form-row">
              <div class="col">
                ...
                <input type="date" name="dob" id="dob" class="form-control" value="<?php echo $_SESSION['c_dob']; ?>" placeholder="DOB" onkeyup="getAgeVal(0)" onblur="getAgeVal(0);" required>
                <div class="invalid-feedback">Please Select Valid Dob</div> 
              </div>
              <div class="col">
                <label>&nbsp Age :</label>
                <input type="text" name="agedata" id="age" class="form-control" placeholder="SELECT DOB " value="<?php echo $_SESSION['c_age']; ?>" required readonly>
            ...
            <div class="form-row">
              <div class="col">
                ...
                <textarea name="add" id="validation6" rows="1" cols="27" class="form-control"  required><?php echo $_SESSION['add']; ?></textarea>
                <div class="invalid-feedback">Please Enter Address</div>
              </div>
              <div class="col">
                <label>&nbsp District :</label>
                <input type="text" id="validation7" name="dist" class="form-control" value="<?php echo $_SESSION['dist']; ?>" placeholder="District" required>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <select id="inputState" name="state" class="form-control" value="<?php echo $_SESSION['c_state']; ?>" required>
              ...
              <div class="form-group col-md-4">
                ...
                <select id="incountry" name="country" class="form-control" value="<?php echo $_SESSION['c_country']; ?>" required>
                  <option>India</option>
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" id="validation8" name="pin" class="form-control" id="inputZip" value="<?php echo $_SESSION['pin']; ?>" required>
            ...
            <div class="form-row">
              <div class="col">
                ...
                <input type="text" id="validation9" name="mobile" class="form-control" value="<?php echo $_SESSION['mobile']; ?>" required>
                <div class="invalid-feedback">Please Enter Mobile</div>
              </div>
              <div class="col">
                <label>&nbsp Email :</label>
                <input type="email" id="validation10" name="email" class="form-control" value="<?php echo $_SESSION['email']; ?>" required>
    ...
    <div class="row pt-5">
      ...
      <div class="col-lg-3 col-md-6 mb-5">
        ...
        <div class="d-flex flex-column justify-content-start">
          ...
          <a class="text-white mb-2" href="mycoach.php"><i class="fa fa-angle-right mr-2"></i>Add Player</a>
          <a class="text-white mb-2" href="myteam.php"><i class="fa fa-angle-right mr-2"></i>Remove Player</a>
          <a class="text-white mb-2" href="report.php"><i class="fa fa-angle-right mr-2"></i>Player List</a>
      ...
      <div class="col-lg-3 col-md-6 mb-5">
        ...
        <div class="d-flex flex-column justify-content-start">
          ...
          <a class="text-white mb-2" href="mymatch.php"><i class="fa fa-angle-right mr-2"></i>Matches</a>
