...
<body class="bg-white">
    ...
    <!-- Navbar End -->
      ...
      <div class="container-fluid page-header mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <div class="d-inline-flex">
                <p class="m-0 text-white"><a class="text-white" title="Please Check Report Monthly">Remove Player</a></p>
     ...
     <div> <h2 align="center">Delete Player </h2></div>  
        ...
        <?php
              ...
              {            
                ...
                while ($row = mysqli_fetch_array($qry)) {
                  ...
                  echo "<td><a class='btn btn-danger' href='delp.php?id=$row[0]'><i class='fa fa-trash'></i></a></td>";
                  echo "</tr>";
                }
            }
            else
