...
<body class="bg-white">
  ...
  <div class="container-fluid page-header mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
      ...
      <div class="d-inline-flex">
        <p class="m-0 text-white"><a class="text-white" title="Please Check Report Monthly">Player Report</a></p>
  ...
  <div>
    <h2 align="center">Player Report </h2>
  </div>
    ...
    <table class="table table-hover table-bordered">
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_array($qry)) {
          ...
          echo "<td><a href='reportprocess.php?id=$row[0]'><button type='button' class='btn btn-warning'><i class='fa fa-file'></i></button></a></td>";
        }
      }
      else
      {
          echo "<td colspan='9' align='center'>Player Not Selected</td>";
          echo "</tr>";
      }  
        ?>
